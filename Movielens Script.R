...
# calculate the overall average rating on the training data set
...
# calculate b_i for each movie and let's compare it  with the overall average u on training data set
...
#  Lets add b_i into the validation set and lets predict all unknown ratings with u and b_i
...
# The final linear model with the minimum lambda to optimise the model
